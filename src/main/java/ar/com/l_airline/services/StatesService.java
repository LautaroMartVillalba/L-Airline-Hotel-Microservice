...
public class StatesService {
     ...
     * @throws MissingDataException if the stateCode is blank.
     * @throws NotFoundInDatabaseException if no state is found with the given code.
     */
     ...
     * @throws MissingDataException if the countryCode is blank.
     */
     ...
     * @throws MissingDataException if the subdivisionName is blank.
     */
